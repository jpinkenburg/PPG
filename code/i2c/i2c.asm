...
; PB0 and PB1 are out, don't care receiving.
	ldi temp1, 0b11
	out DDRB, temp1 ;set pb0 and pb1 as outputs
; as a initial, SDA and SCL are high
	ldi temp1, 0b11
	out PORTB, temp1 ;set SDA and SDL high
	ldi display,0x00
...
start:
	ldi temp1, 0b10
	out PORTB, temp1 ;SCL high, SDA low => start I2C transmission
	rcall delay
	ldi temp1, 0b00 ;SCL low, SDA low
	out PORTB, temp1
	rcall delay
	ret
	;cl, da
...
init:
	ldi temp1, 0b11
	out PORTB, temp1 ;write both lines high
	rcall delay
	ret
	;cl da
bit_high:
